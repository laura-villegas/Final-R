...
```
El mapa binario se construyó con un umbral de 0.5 y evidencia una disminución considerable en la proyección de las zonas de presencia de la especie en comparación con el mismo mapa para el clima actual. 
